...
// H-Bridge Connections (both PWM inputs driven by GPIO 12)
#define MTR_PWM     12
#define LEFT_M0     15
#define LEFT_M1     14
#define RIGHT_M0    13
...
//int pos = 90;    // Góc ban đầu của servo
            ...
            <section id="buttons">
               ...
               <br>
                <div id="sliders" class="slider-container">
                  ...
                  <tr><td>Servo Control:</td><td align="center" colspan="2"><input type="range" id="servoSlider" min="0" max="180" value="90" onchange="try{fetch(document.location.origin+'/control?var=servo&val='+this.value);}catch(e){}"></td></tr>
        ...
        <script>
          ...
          document.addEventListener('DOMContentLoaded', function() {
            ...
            servoSlider.oninput = function() {
              try {
                fetch(`${document.location.origin}/control?var=servo&val=${this.value}`);
                  } catch (e) {}
            };
          });
        </script>
...
void robot_setup()
{
    ...
    myservo.attach(SERVO_PIN);  // Mở kết nối servo
    update_servo(90);  // Đặt góc servo ban đầu là 90 độ
...
void update_servo(int angle) {
    ...
    myservo.write(angle);  // set the servo position according to the slider value
}
